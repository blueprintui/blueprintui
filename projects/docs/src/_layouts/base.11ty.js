            ...
            <div bp-layout="block gap:sm">
              <bp-field>
                ...
                <bp-select id="theme-color">
                  <bp-option value="">light</bp-option>
                  <bp-option value="dark" selected>dark</bp-option>
                </bp-select>
              </bp-field>
              <bp-field>
        ...
        <bp-panel id="nav-panel" slot="aside-start" behavior="auto">
          <bp-tree>
            <bp-tree-item expanded>
              ...
              <bp-tree-item ${data.page.url === '/changelog.html' ? 'selected aria-current="page"' : ''}><a href="/changelog.html">Changelog</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/support.html' ? 'selected aria-current="page"' : ''}><a href="/support.html">Support</a></bp-tree-item>
              <bp-tree-item><a href="https://github.com/blueprintui">Github</a></bp-tree-item>
            </bp-tree-item>
            <bp-tree-item expanded>
              <a href="/integrations/angular.html">Integrations</a>
              <bp-tree-item ${data.page.url === '/integrations/angular.html' ? 'selected aria-current="page"' : ''}><a href="/integrations/angular.html">Angular</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/integrations/vue.html' ? 'selected aria-current="page"' : ''}><a href="/integrations/vue.html">Vue</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/integrations/react.html' ? 'selected aria-current="page"' : ''}><a href="/integrations/react.html">React</a></bp-tree-item>
              <bp-tree-item><a href="https://stackblitz.com/@coryrylan/collections/blueprintui" target="_blank">Demos</a></bp-tree-item>
            </bp-tree-item>
            <bp-tree-item expanded>
              <a href="/docs/foundation/themes.html">Foundation</a>
              <bp-tree-item ${data.page.url === '/docs/foundation/themes.html' ? 'selected aria-current="page"' : ''}><a href="/docs/foundation/themes.html">Themes</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/docs/foundation/typography.html' ? 'selected aria-current="page"' : ''}><a href="/docs/foundation/typography.html">Typography</a></bp-tree-item>
            ...
            <bp-tree-item expanded>
              ...
              <bp-tree-item ${data.page.url === '/docs/layout/' ? 'selected aria-current="page"' : ''}><a href="/docs/layout">Getting Started</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/docs/layout/block/' ? 'selected aria-current="page"' : ''}><a href="/docs/layout/block">Block</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/docs/layout/inline/' ? 'selected aria-current="page"' : ''}><a href="/docs/layout/inline">Inline</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/docs/layout/grid/' ? 'selected aria-current="page"' : ''}><a href="/docs/layout/grid">Grid</a></bp-tree-item>
            </bp-tree-item>
            <bp-tree-item expanded>
              ...
              <bp-tree-item ${data.page.url === '/docs/components/button-icon.html' ? 'selected aria-current="page"' : ''}><a href="/docs/components/button-icon.html">Button Icon</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/docs/components/button-resize.html' ? 'selected aria-current="page"' : ''}><a href="/docs/components/button-resize.html">Button Resize</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/docs/components/button-sort.html' ? 'selected aria-current="page"' : ''}><a href="/docs/components/button-sort.html">Button Sort</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/docs/components/card.html' ? 'selected aria-current="page"' : ''}><a href="/docs/components/card.html">Card</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/docs/components/chat.html' ? 'selected aria-current="page"' : ''}><a href="/docs/components/chat.html">Chat</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/docs/components/checkbox.html' ? 'selected aria-current="page"' : ''}><a href="/docs/components/checkbox.html">Checkbox</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/docs/components/color.html' ? 'selected aria-current="page"' : ''}><a href="/docs/components/color.html">Color</a></bp-tree-item>
              <bp-tree-item><a href="/docs/grid.html#description">Data Grid</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/docs/components/date.html' ? 'selected aria-current="page"' : ''}><a href="/docs/components/date.html">Date</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/docs/components/dialog.html' ? 'selected aria-current="page"' : ''}><a href="/docs/components/dialog.html">Dialog</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/docs/components/divider.html' ? 'selected aria-current="page"' : ''}><a href="/docs/components/divider.html">Divider</a></bp-tree-item>
              ...
              <bp-tree-item ${data.page.url === '/docs/components/radio.html' ? 'selected aria-current="page"' : ''}><a href="/docs/components/radio.html">Radio</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/docs/components/range.html' ? 'selected aria-current="page"' : ''}><a href="/docs/components/range.html">Range</a></bp-tree-item>
              ...
              <bp-tree-item ${data.page.url === '/docs/components/toggletip.html' ? 'selected aria-current="page"' : ''}><a href="/docs/components/toggletip.html">Toggletip</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/docs/components/tooltip.html' ? 'selected aria-current="page"' : ''}><a href="/docs/components/tooltip.html">Tooltip</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/docs/components/tree.html' ? 'selected aria-current="page"' : ''}><a href="/docs/components/tree.html">Tree</a></bp-tree-item>
            </bp-tree-item>
            <bp-tree-item expanded>
              <a href="/docs/grid.html">Data Grid</a>
              <bp-tree-item ${data.page.url === '/docs/grid.html' ? 'selected aria-current="page"' : ''}><a href="/docs/grid.html">Getting Started</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/docs/grid/footer.html' ? 'selected aria-current="page"' : ''}><a href="/docs/grid/footer.html">Footer</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/docs/grid/placeholder.html' ? 'selected aria-current="page"' : ''}><a href="/docs/grid/placeholder.html">Placeholder</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/docs/grid/async.html' ? 'selected aria-current="page"' : ''}><a href="/docs/grid/async.html">Async</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/docs/grid/responsive.html' ? 'selected aria-current="page"' : ''}><a href="/docs/grid/responsive.html">Responsive</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/docs/grid/height.html' ? 'selected aria-current="page"' : ''}><a href="/docs/grid/height.html">Height</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/docs/grid/pagination.html' ? 'selected aria-current="page"' : ''}><a href="/docs/grid/pagination.html">Pagination</a></bp-tree-item>
              ...
              <bp-tree-item ${data.page.url === '/docs/grid/column-fixed.html' ? 'selected aria-current="page"' : ''}><a href="/docs/grid/column-fixed.html">Column Fixed</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/docs/grid/column-sticky.html' ? 'selected aria-current="page"' : ''}><a href="/docs/grid/column-sticky.html">Column Sticky</a></bp-tree-item>
              ...
              <bp-tree-item ${data.page.url === '/docs/grid/row-height.html' ? 'selected aria-current="page"' : ''}><a href="/docs/grid/row-height.html">Row Height</a></bp-tree-item>
              <!-- <bp-tree-item ${data.page.url === '/docs/grid/detail.html' ? 'selected aria-current="page"' : ''}><a href="/docs/grid/detail.html" bp-layout="inline gap:md">Row Detail</a></bp-tree-item> -->
              <bp-tree-item ${data.page.url === '/docs/grid/row-action.html' ? 'selected aria-current="page"' : ''}><a href="/docs/grid/row-action.html">Row Action</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/docs/grid/row-action-bulk.html' ? 'selected aria-current="page"' : ''}><a href="/docs/grid/row-action-bulk.html">Row Action Bulk</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/docs/grid/row-sticky.html' ? 'selected aria-current="page"' : ''}><a href="/docs/grid/row-sticky.html">Row Sticky</a></bp-tree-item>
              <bp-tree-item ${data.page.url === '/docs/grid/row-stripe.html' ? 'selected aria-current="page"' : ''}><a href="/docs/grid/row-stripe.html">Row Stripe</a></bp-tree-item>
