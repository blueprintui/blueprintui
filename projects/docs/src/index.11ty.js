import componentSchema from '../..//components/.drafter/schema.json' with { type: 'json' };
import iconSchema from '../..//icons/.drafter/schema.json' with { type: 'json' };
import gridSchema from '../..//grid/.drafter/schema.json' with { type: 'json' };
