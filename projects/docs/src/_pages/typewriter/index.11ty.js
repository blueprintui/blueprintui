...
<style>
  ...
  .demos bp-keynav-list {
    display: grid;
    gap: 8px;
    grid-template-columns: repeat(auto-fit, minmax(50px, 1fr));
  }

  .demos bp-keynav-list button {
    min-height: 100px;
  }

  .demos bp-keynav-list[layout='block'] {
    grid-template-columns: 1fr;
    justify-items: center;
    width: 100%;
  }

  .demos bp-keynav-list[layout='block'] button {
    min-height: 55px;
    width: 100%;
  }
  ...
  .demos bp-keynav-list button:focus,
  .demos bp-keynav-list button:focus {
...
\`\`\`html
<script type="module">
  import 'https://cdn.jsdelivr.net/npm/@blueprintui/typewriter@0.0.0/include/keynav-list.js/+esm';
</script>
<bp-keynav-list loop layout="inline">
  <button>1</button>
  <button>2</button>
  <button>3</button>
  <button>4</button>
...
keynav follows the aria [grid navitation](https://w3c.github.io/aria-practices/#gridNav_focus) patterns. keynav computes the number of columns by computing the number of items from the CSS property \`grid-template-columns\`. If the columns are dynamic you can explicity set the column count \`<bp-keynav-list columns="4">\`.
...
<bp-keynav-list loop layout="block">
  <button>1</button>
  <button>2</button>
  <button>3</button>
  <button>4</button>
...
<footer bp-layout="inline gap:sm inline:center">
  ...
  <a bp-text="link" href="https://github.com/blueprintui/blueprintui/tree/main/projects/typewriter">GitHub</a>
  <bp-divider orientation="vertical"></bp-divider>
