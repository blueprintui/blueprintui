...
<style>
  ...
  .demos bp-keylist button {
    min-height: 100px;
  }

  .demos bp-keylist[direction='block'] {
    grid-template-columns: 1fr;
    justify-items: center;
    width: 100%;
  }

  .demos bp-keylist[direction='block'] button {
    min-height: 55px;
    width: 100%;
  }

  .demos bp-keylist button,
  .demos bp-keygrid button {
    background: hsl(240, 35%, 50%);
    color: #fff;
    padding: 8px;
    border: 0;
  ...
  .demos bp-keylist button:focus,
  .demos bp-keygrid button:focus {
...
<main bp-layout="block gap:lg">
  ...
  <bp-keylist loop bp-layout="inline gap:xs inline:center m-t:xs">
    <bp-button action="outline" style="--color: hsl(240, 70%, 70%)">
