      ...
      <bp-shell>
        ...
        <bp-nav expanded>
          ...
          <bp-nav-group expanded>
            ...
            <bp-nav-item ${data.page.url === '/docs/grid/column-groups.html' ? 'selected aria-current="page"' : ''}><a href="/docs/grid/column-groups.html" bp-layout="inline gap:md">Column Groups</a> <bp-badge bp-layout="block:center" status="warning"></bp-badge></bp-nav-item>
            <bp-nav-item ${data.page.url === '/docs/grid/column-span.html' ? 'selected aria-current="page"' : ''}><a href="/docs/grid/column-span.html" bp-layout="inline gap:md">Column Span</a> <bp-badge bp-layout="block:center" status="warning"></bp-badge></bp-nav-item>
