      ...
      <bp-shell>
        ...
        <bp-nav expanded>
          <bp-nav-group expanded>
            ...
            ${data.site.site.enablePro ? /* html */`<bp-nav-item ${data.page.url === '/pricing.html' ? 'selected aria-current="page"' : ''}><a href="/pricing.html">Pricing</a></bp-nav-item>` : ''}
          ...
          <bp-nav-group expanded>
            ...
            ${data.site.site.enablePro ? /* html */`<bp-nav-item ${data.page.url === '/docs/grid/pro-range-selection.html' ? 'selected aria-current="page"' : ''}><a href="/docs/grid/pro-range-selection.html" bp-layout="inline gap:md">Range Selection</a> <bp-badge status="accent"></bp-badge></bp-nav-item>` : ''}
            ${data.site.site.enablePro ? /* html */`<bp-nav-item ${data.page.url === '/docs/grid/pro-csv.html' ? 'selected aria-current="page"' : ''}><a href="/docs/grid/pro-csv.html" bp-layout="inline gap:md">CSV</a> <bp-badge status="accent"></bp-badge></bp-nav-item>` : ''}
            ...
            ${data.site.site.enablePro ? /* html */`<bp-nav-item ${data.page.url === '/docs/grid/pro-column-resize.html' ? 'selected aria-current="page"' : ''}><a href="/docs/grid/pro-column-resize.html" bp-layout="inline gap:md">Column Resize</a> <bp-badge status="accent"></bp-badge></bp-nav-item>` : ''}
            ${data.site.site.enablePro ? /* html */`<bp-nav-item ${data.page.url === '/docs/grid/pro-draggable-columns.html' ? 'selected aria-current="page"' : ''}><a href="/docs/grid/pro-draggable-columns.html" bp-layout="inline gap:md">Draggable Columns</a> <bp-badge status="accent"></bp-badge></bp-nav-item>` : ''}
            ${data.site.site.enablePro ? /* html */`<bp-nav-item ${data.page.url === '/docs/grid/pro-draggable-rows.html' ? 'selected aria-current="page"' : ''}><a href="/docs/grid/pro-draggable-rows.html" bp-layout="inline gap:md">Draggable Rows</a> <bp-badge status="accent"></bp-badge></bp-nav-item>` : ''}
            ...
            ${data.site.site.enablePro ? /* html */`<bp-nav-item ${data.page.url === '/docs/grid/pro-detail.html' ? 'selected aria-current="page"' : ''}><a href="/docs/grid/pro-detail.html" bp-layout="inline gap:md">Row Detail</a> <bp-badge status="accent"></bp-badge></bp-nav-item>` : ''}
