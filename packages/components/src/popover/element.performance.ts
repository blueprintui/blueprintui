...
describe('bp-popover performance', () => {
  ...
  it(`should bundle and treeshake under 13.3kb`, async () => {
    expect((await testBundleSize('@blueprintui/components/include/popover.js', { optimize: true })).kb).toBeLessThan(13.3);
  });
