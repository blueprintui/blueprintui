...
describe('bp-header performance', () => {
  ...
  it(`should bundle and treeshake under 7.6kb`, async () => {
    expect((await testBundleSize('@blueprintui/components/include/header.js', { optimize: true })).kb).toBeLessThan(7.6);
  });
