...
describe('bp-tabs performance', () => {
  ...
  it(`should bundle and treeshake under 10.2kb`, async () => {
    expect((await testBundleSize('@blueprintui/components/include/tabs.js', { optimize: true })).kb).toBeLessThan(10.2);
  });
