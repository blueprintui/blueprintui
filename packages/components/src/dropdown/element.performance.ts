...
describe('bp-dropdown performance', () => {
  ...
  it(`should bundle and treeshake under 13.2kb`, async () => {
    expect((await testBundleSize('@blueprintui/components/include/dropdown.js', { optimize: true })).kb).toBeLessThan(13.2);
  });
