...
export function draggableRows() {
  return /* html */`
    <script type="module">
      ...
      import '@blueprintui/grid-pro/include/draggable-row.js';
    ...
    <section bp-layout="block gap:xs">
      <bp-grid column-layout="flex" row-style="border" aria-label="draggable row datagrid demo" height="390" style="max-width: 800px">
        <bp-grid-header>
          ...
          <bp-grid-column>${column.label}</bp-grid-column>`).join('\n')}
        </bp-grid-header>
...
export function draggableRowsMultiGrid() {
  return /* html */`
    <script type="module">
      import '@blueprintui/grid/include/core.js';
      import '@blueprintui/grid/include/keynav.js';
